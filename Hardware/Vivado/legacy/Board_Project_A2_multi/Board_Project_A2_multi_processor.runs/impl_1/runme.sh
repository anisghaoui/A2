...
HD_PWD='C:/A2_project/Vivado/Board_Project_A2_multi_processor/Board_Project_A2_multi_processor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_multi_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_multi_wrapper.tcl -notrace
