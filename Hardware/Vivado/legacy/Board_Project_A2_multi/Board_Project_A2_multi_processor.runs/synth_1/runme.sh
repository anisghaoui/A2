...
HD_PWD='C:/A2_project/Vivado/Board_Project_A2_multi_processor/Board_Project_A2_multi_processor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_multi_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_multi_wrapper.tcl
