...
HD_PWD='C:/Users/Qlala/Documents/M2_SETI/A2/git/A2/Hardware/Vivado/Demo_IP_HLS/Demo_IP_HLS_kmeans/Demo_IP_HLS_kmeans.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_IP_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_IP_wrapper.tcl -notrace
