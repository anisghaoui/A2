...
HD_PWD='C:/Users/Qlala/Documents/M2_SETI/A2/git/A2/Hardware/Vivado/Demo_IP_HLS/Demo_IP_HLS_kmeans/Demo_IP_HLS_kmeans.runs/design_IP_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_IP_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_IP_axi_gpio_0_0.tcl
