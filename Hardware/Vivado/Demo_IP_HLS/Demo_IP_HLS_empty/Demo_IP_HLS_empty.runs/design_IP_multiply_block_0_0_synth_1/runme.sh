...
HD_PWD='C:/A2_project/Vivado/Demo_IP_HLS/Demo_IP_HLS_empty/Demo_IP_HLS_empty.runs/design_IP_multiply_block_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_IP_multiply_block_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_IP_multiply_block_0_0.tcl
