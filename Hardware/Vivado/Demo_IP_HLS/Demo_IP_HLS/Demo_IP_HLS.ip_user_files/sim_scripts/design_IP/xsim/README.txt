...
#
# Generated by export_simulation on Wed Feb 19 15:34:33 +0100 2020
#
################################################################################
...
'-reset_run' switch to the './design_IP.sh' script.

./design_IP.sh -reset_run
...
./design_IP.sh -noclean_files

For more information on the script, please type './design_IP.sh -help'.
