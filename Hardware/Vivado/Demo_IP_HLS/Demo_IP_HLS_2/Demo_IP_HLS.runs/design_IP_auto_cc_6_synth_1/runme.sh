...
HD_PWD='C:/A2_project/Vivado/Demo_IP_HLS/Demo_IP_HLS_2/Demo_IP_HLS.runs/design_IP_auto_cc_6_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_IP_auto_cc_6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_IP_auto_cc_6.tcl
