...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = kmeans
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = kmeans_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = multiply_block
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = multiply_block_0
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = multiply_block_32
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = multiply_block_32_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = multiply_block_64
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = multiply_block_64_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = pearson
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = pearson_0
END
