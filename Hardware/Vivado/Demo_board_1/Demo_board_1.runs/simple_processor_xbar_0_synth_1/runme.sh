...
HD_PWD='C:/Users/Qlala/Documents/M2_SETI/A2/git/A2/Hardware/Vivado/Demo_board_1/Demo_board_1.runs/simple_processor_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simple_processor_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simple_processor_xbar_0.tcl
