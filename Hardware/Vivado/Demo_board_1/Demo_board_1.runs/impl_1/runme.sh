...
HD_PWD='C:/Users/Qlala/Documents/M2_SETI/A2/git/A2/Hardware/Vivado/Demo_board_1/Demo_board_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log simple_processor_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source simple_processor_wrapper.tcl -notrace
