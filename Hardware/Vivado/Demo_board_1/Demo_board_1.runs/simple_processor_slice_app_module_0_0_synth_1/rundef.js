...
ISEStep( "vivado",
         "-log simple_processor_slice_app_module_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simple_processor_slice_app_module_0_0.tcl" );
