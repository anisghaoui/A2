...
--Command     : generate_target simple_processor_wrapper.bd
--Design      : simple_processor_wrapper
...
end simple_processor_wrapper;

architecture STRUCTURE of simple_processor_wrapper is
  ...
  end component simple_processor;
begin
simple_processor_i: component simple_processor
     port map (
