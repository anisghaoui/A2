...
HD_PWD='C:/Users/Qlala/Documents/M2_SETI/A2/git/A2/Hardware/Vivado/multiprocessor/project_microblaze_test/project_microblaze_test.runs/design_mb_xbar_6_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_mb_xbar_6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_mb_xbar_6.tcl
