...
HD_PWD='C:/Users/Qlala/Documents/M2_SETI/A2/git/A2/Hardware/Vivado/multiCPU/prj_BRAM/prj_BRAM.runs/design_mb_auto_ds_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_mb_auto_ds_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_mb_auto_ds_0.tcl
