...
HD_PWD='C:/A2_project/Board_Project_A2_multi_processor.runs/design_multi_mdm_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_multi_mdm_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_multi_mdm_1_0.tcl
