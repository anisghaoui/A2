...
EAStep vivado -log design_multi_smartconnect_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_multi_smartconnect_0_0.tcl
