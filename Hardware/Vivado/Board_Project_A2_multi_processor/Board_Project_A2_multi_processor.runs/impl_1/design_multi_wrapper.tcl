...
set rc [catch {
  ...
  catch { write_sysdef -hwdef design_multi_wrapper.hwdef -bitfile design_multi_wrapper.bit -meminfo design_multi_wrapper.mmi -file design_multi_wrapper.sysdef }
  catch {write_debug_probes -quiet -force design_multi_wrapper}
  catch {file copy -force design_multi_wrapper.ltx debug_nets.ltx}
