...
architecture STRUCTURE of bd_0 is
  ...
  signal s_axi_CONTROL_BUS_0_1_ARADDR : STD_LOGIC_VECTOR ( 4 downto 0 );
  signal s_axi_CONTROL_BUS_0_1_ARREADY : STD_LOGIC;
  signal s_axi_CONTROL_BUS_0_1_ARVALID : STD_LOGIC;
  signal s_axi_CONTROL_BUS_0_1_AWADDR : STD_LOGIC_VECTOR ( 4 downto 0 );
  ...
  attribute X_INTERFACE_PARAMETER of ap_clk : signal is "XIL_INTERFACENAME CLK.AP_CLK, ASSOCIATED_BUSIF m_axi_INPUT_r:s_axi_CONTROL_BUS, ASSOCIATED_RESET ap_rst_n, CLK_DOMAIN bd_0_ap_clk_0, FREQ_HZ 100000000.0, INSERT_VIP 0, PHASE 0.000";
...
begin
  ...
  s_axi_CONTROL_BUS_0_1_ARADDR(4 downto 0) <= s_axi_CONTROL_BUS_araddr(4 downto 0);
  s_axi_CONTROL_BUS_0_1_ARVALID <= s_axi_CONTROL_BUS_arvalid;
  s_axi_CONTROL_BUS_0_1_AWADDR(4 downto 0) <= s_axi_CONTROL_BUS_awaddr(4 downto 0);
...
hls_inst: component bd_0_hls_inst_0
     port map (
      ...
      m_axi_INPUT_r_WSTRB(3 downto 0) => hls_inst_m_axi_INPUT_r_WSTRB(3 downto 0),
      m_axi_INPUT_r_WVALID => hls_inst_m_axi_INPUT_r_WVALID,
      s_axi_CONTROL_BUS_ARADDR(4 downto 0) => s_axi_CONTROL_BUS_0_1_ARADDR(4 downto 0),
      s_axi_CONTROL_BUS_ARREADY => s_axi_CONTROL_BUS_0_1_ARREADY,
      s_axi_CONTROL_BUS_ARVALID => s_axi_CONTROL_BUS_0_1_ARVALID,
      s_axi_CONTROL_BUS_AWADDR(4 downto 0) => s_axi_CONTROL_BUS_0_1_AWADDR(4 downto 0),
      s_axi_CONTROL_BUS_AWREADY => s_axi_CONTROL_BUS_0_1_AWREADY,
