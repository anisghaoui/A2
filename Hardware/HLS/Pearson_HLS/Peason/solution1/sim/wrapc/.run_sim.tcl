...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "pearson.autotvin.dat"
	set constFileTvOut       "pearson.autotvout.dat"
	set constFileHdlTvIn     "pearson.autohdltvin.dat"
	set constFileHdlTvOut    "pearson.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
