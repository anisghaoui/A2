...
set C_modelArgMapList {[ 
	{ "Name" : "mat", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "col", "interface" : "wire", "bitwidth" : 1, "direction" : "READONLY"} , 
 	{ "Name" : "moy", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ col sc_in sc_lv 1 signal 2 } 
	{ moy sc_in sc_lv 32 signal 3 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "col", "direction": "in", "datatype": "sc_lv", "bitwidth":1, "type": "signal", "bundle":{"name": "col", "role": "default" }} , 
 	{ "name": "moy", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "moy", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.pearson_faddfsub_32ns_32ns_32_5_full_dsp_1_U14", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.pearson_faddfsub_32ns_32ns_32_5_full_dsp_1_U15", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.pearson_fmul_32ns_32ns_32_4_max_dsp_1_U16", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.pearson_fdiv_32ns_32ns_32_16_1_U17", "Parent" : "0"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.pearson_fsqrt_32ns_32ns_32_12_1_U18", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	col { ap_none {  { col in_data 0 1 } } }
	moy { ap_none {  { moy in_data 0 32 } } }
}
