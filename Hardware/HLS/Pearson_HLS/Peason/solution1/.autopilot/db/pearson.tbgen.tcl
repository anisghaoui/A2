...
set C_modelArgMapList {[ 
	{ "Name" : "INPUT_r", "interface" : "axi_master", "bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "mat","cData": "float","bit_use": { "low": 0,"up": 31},"offset": { "type": "dynamic","port_name": "mat","bundle": "AXILiteS"},"direction": "READONLY","cArray": [{"low" : 0,"up" : 19,"step" : 1},{"low" : 0,"up" : 1,"step" : 1}]}]}]} , 
 	{ "Name" : "OUTPUT_r", "interface" : "axi_master", "bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":31,"cElement": [{"cName": "result","cData": "float","bit_use": { "low": 0,"up": 31},"offset": { "type": "dynamic","port_name": "result","bundle": "AXILiteS"},"direction": "WRITEONLY","cArray": [{"low" : 0,"up" : 0,"step" : 1}]}]}]} , 
 	{ "Name" : "mat", "interface" : "axi_slave", "bundle":"CONTROL_BUS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":16}, "offset_end" : {"in":23}} , 
 	{ "Name" : "result", "interface" : "axi_slave", "bundle":"CONTROL_BUS","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "offset" : {"in":24}, "offset_end" : {"in":31}} ]}
...
set NewPortList {[ 
	{ "name": "s_axi_CONTROL_BUS_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "CONTROL_BUS", "role": "AWADDR" },"address":[{"name":"pearson","role":"start","value":"0","valid_bit":"0"},{"name":"pearson","role":"continue","value":"0","valid_bit":"4"},{"name":"pearson","role":"auto_start","value":"0","valid_bit":"7"},{"name":"mat","role":"data","value":"16"},{"name":"result","role":"data","value":"24"}] },
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "3", "4", "10", "13", "17", "18", "19"],
		"CDFG" : "pearson",
		"Protocol" : "ap_ctrl_hs",
		...
		"Port" : [
			{"Name" : "INPUT_r", "Type" : "MAXI", "Direction" : "I",
				...
				"SubConnect" : [
					{"ID" : "10", "SubInstance" : "grp_moyenne_fu_111", "Port" : "mat"},
					{"ID" : "13", "SubInstance" : "grp_moyenneXY_fu_121", "Port" : "mat"},
					{"ID" : "4", "SubInstance" : "grp_ecartType_fu_100", "Port" : "mat"}]},
		...
		"SubInstanceBlock" : [
			{"SubInstance" : "grp_ecartType_fu_100", "SubBlockPort" : ["mat_blk_n_AR", "mat_blk_n_R"]},
			{"SubInstance" : "grp_moyenne_fu_111", "SubBlockPort" : ["mat_blk_n_AR", "mat_blk_n_R"]},
			{"SubInstance" : "grp_moyenneXY_fu_121", "SubBlockPort" : ["mat_blk_n_AR", "mat_blk_n_R"]}]},
	...
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.pearson_OUTPUT_r_m_axi_U", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_ecartType_fu_100", "Parent" : "0", "Child" : ["5", "6", "7", "8", "9"],
		"CDFG" : "ecartType",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
	...
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_ecartType_fu_100.pearson_faddfsub_32ns_32ns_32_5_full_dsp_1_U14", "Parent" : "4"},
	{"ID" : "6", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_ecartType_fu_100.pearson_faddfsub_32ns_32ns_32_5_full_dsp_1_U15", "Parent" : "4"},
	{"ID" : "7", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_ecartType_fu_100.pearson_fmul_32ns_32ns_32_4_max_dsp_1_U16", "Parent" : "4"},
	{"ID" : "8", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_ecartType_fu_100.pearson_fdiv_32ns_32ns_32_16_1_U17", "Parent" : "4"},
	{"ID" : "9", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_ecartType_fu_100.pearson_fsqrt_32ns_32ns_32_12_1_U18", "Parent" : "4"},
	{"ID" : "10", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_moyenne_fu_111", "Parent" : "0", "Child" : ["11", "12"],
		"CDFG" : "moyenne",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "Aligned", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			...
			{"Name" : "mat_offset", "Type" : "None", "Direction" : "I"},
			{"Name" : "col", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "11", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_moyenne_fu_111.pearson_fadd_32ns_32ns_32_5_full_dsp_1_U1", "Parent" : "10"},
	{"ID" : "12", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_moyenne_fu_111.pearson_fdiv_32ns_32ns_32_16_1_U2", "Parent" : "10"},
	{"ID" : "13", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_moyenneXY_fu_121", "Parent" : "0", "Child" : ["14", "15", "16"],
		"CDFG" : "moyenneXY",
		"Protocol" : "ap_ctrl_hs",
		"ControlExist" : "1", "ap_start" : "1", "ap_ready" : "1", "ap_done" : "1", "ap_continue" : "0", "ap_idle" : "1",
		"Pipeline" : "Aligned", "UnalignedPipeline" : "0", "RewindPipeline" : "0", "ProcessNetwork" : "0",
		...
		"Port" : [
			{"Name" : "mat", "Type" : "MAXI", "Direction" : "I",
				"BlockSignal" : [
					...
					{"Name" : "mat_blk_n_R", "Type" : "RtlPort"}]},
			{"Name" : "mat_offset", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "14", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_moyenneXY_fu_121.pearson_fadd_32ns_32ns_32_5_full_dsp_1_U8", "Parent" : "13"},
	{"ID" : "15", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_moyenneXY_fu_121.pearson_fmul_32ns_32ns_32_4_max_dsp_1_U9", "Parent" : "13"},
	{"ID" : "16", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_moyenneXY_fu_121.pearson_fdiv_32ns_32ns_32_16_1_U10", "Parent" : "13"},
	{"ID" : "17", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.pearson_fsub_32ns_32ns_32_5_full_dsp_1_U25", "Parent" : "0"},
	{"ID" : "18", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.pearson_fmul_32ns_32ns_32_4_max_dsp_1_U26", "Parent" : "0"},
	{"ID" : "19", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.pearson_fdiv_32ns_32ns_32_16_1_U27", "Parent" : "0"}]}


set ArgLastReadFirstWriteLatency {
	pearson {
		INPUT_r {Type I LastRead 46 FirstWrite -1}
		OUTPUT_r {Type O LastRead 751 FirstWrite 750}
