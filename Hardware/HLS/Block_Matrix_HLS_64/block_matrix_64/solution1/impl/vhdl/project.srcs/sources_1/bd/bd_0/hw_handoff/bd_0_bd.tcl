...
proc create_root_design { parentCell } {
  ...
  set m_axi_INPUT_r [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 m_axi_INPUT_r ]
  ...
  set hls_inst [ create_bd_cell -type ip -vlnv xilinx.com:hls:multiply_block_64:1.0 hls_inst ]
