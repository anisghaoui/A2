...
if {[file isfile multiply_block.autotvin.dat]} {
	file delete -force multiply_block.autotvin.dat
}

if {[file isfile multiply_block.autotvout.dat]} {
	file delete -force multiply_block.autotvout.dat
}
