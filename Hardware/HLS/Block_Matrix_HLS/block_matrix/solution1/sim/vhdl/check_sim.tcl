...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.multiply_block.autotvin_mA.dat"
         "c.multiply_block.autotvin_mB.dat"
         "c.multiply_block.autotvin_mC.dat"
         "c.multiply_block.autotvout_mC.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.multiply_block.autotvout_mC.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
