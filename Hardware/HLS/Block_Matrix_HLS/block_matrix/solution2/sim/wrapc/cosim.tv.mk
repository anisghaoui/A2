...
$(ObjDir)/BMM_main.c_pre.c.tb.o : BMM_main.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) BMM_main.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \

$(ObjDir)/BMM_fonctions.c_pre.c.tb.o : BMM_fonctions.c_pre.c.tb.c $(ObjDir)/.dir
	$(Echo) "   Compiling (apcc) BMM_fonctions.c_pre.c.tb.c" $(AVE_DIR_DLOG)
	$(Verb) $(AUTOCC) -fno-builtin-isinf -fno-builtin-isnan -c $(IFLAG) $(DFLAG) $< -o $@; \
