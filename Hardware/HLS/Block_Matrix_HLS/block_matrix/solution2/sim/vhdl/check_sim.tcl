...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.multiply_block.autotvin_INPUT_r.dat"
         "c.multiply_block.autotvin_OUTPUT_r.dat"
         "c.multiply_block.autotvin_in_mA.dat"
         "c.multiply_block.autotvin_in_mB.dat"
         "c.multiply_block.autotvin_out_mC.dat"
         "c.multiply_block.autotvout_OUTPUT_r.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.multiply_block.autotvout_OUTPUT_r.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
