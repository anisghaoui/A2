...
set out_width 22
set exp i0*i1
set arg_lists {i0 {11 1 +} i1 {11 1 +} p {22 1 +} }
if {${::AESL::PGuard_simmodel_gen}} {
...
set out_width 22
set exp i0*i1+i2
set arg_lists {i0 {11 1 +} i1 {11 1 +} m {22 1 +} i2 {22 1 +} p {22 1 +} c_reg {1} }
if {${::AESL::PGuard_simmodel_gen}} {
...
set ID 7
set MemName sobel_image_in
set CoreName ap_simcore_mem
set PortList { 2 2 }
set DataWd 8
set AddrRange 133120
set AddrWd 18
...
# Memory (RAM/ROM)  definition:
set ID 8
set MemName sobel_image_out
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 8
set AddrRange 132096
set AddrWd 18
set impl_style block
set TrueReset 0
set HasInitializer 0
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 9 \
			corename sobel_CONTROL_BUS_axilite \
			name sobel_CONTROL_BUS_s_axi \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler sobel_CONTROL_BUS_s_axi
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler sobel_INPUT_r_m_axi
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler sobel_OUTPUT_r_m_axi
}
